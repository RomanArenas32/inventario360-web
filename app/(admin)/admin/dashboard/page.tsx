...
export default function AdminDashboardPage() {
  ...
  const stats = [
    { label: 'Total comercios', value: tenants.length, color: 'text-white' },
    { label: 'Activos', value: active, color: 'text-green-400' },
    { label: 'Inactivos', value: tenants.length - active, color: 'text-red-400' },
    { label: 'Plan Pro', value: pro, color: 'text-purple-400' },
  ];
